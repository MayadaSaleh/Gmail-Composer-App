...
public class MainActivity extends Activity implements ComposerViewInterface{
    ...
    public void attachFile(View view) {
        ...
        if (checkInternetConnectivity()) {
            ...
            fragmentTransaction.add(R.id.main_layout,popUpFragment,"pop_up fragment");
    ...
    public void dismissProgressBar() {
        ...
        PopUpFragment dismissFragment = (PopUpFragment) fragmentManager2.findFragmentByTag("pop_up fragment");
        fragmentTransaction2.remove(dismissFragment);
